    ...
    public static ArrayList<Double> SIM(ArrayList<ArrayList<Double>> matrix, int count) {
        ...
        for (; count > 0; count--) {
            ...
            for (int a = 0; a < matrix.size(); a++) {
                ...
                for (int b = 0; b < matrix.get(a).size(); b++) {
                    if (b != matrix.get(a).size() - 1) {
                        //System.out.println("\nroot: " + roots.get(b) + "   " + matrix.get(a).get(b));
            ...
            //System.out.println("-----");
            //roots2.forEach(e -> System.out.println("#" + e));
...
//    public static  double calcIterations(ArrayList<ArrayList<Double>> matrix) {
//        ArrayList<Double> roots = new ArrayList<>(), roots2 = new ArrayList<>();
//
//        for (ArrayList<Double> a : matrix) {
//            roots.add(a.get(a.size() - 1));
...
//        }
//
//        //roots.forEach(e -> System.out.println("\n# " + e));
//
...
//                roots.set(a, roots2.get(a) - roots.get(a));
//            }
//        }
//       // roots2.forEach(e -> System.out.println("\n# " + e));
//
//        double sum = 0;
//
//        for (double d : roots)
